          ...
          switch (sectionType) {
            case 'hero':
              return h('div', {
                ...
                h('div', { style: { maxWidth: '37.5rem', margin: '0 auto' } },
                  h('h2', {
                    style: {
                      fontSize: '2.5rem',
                      lineHeight: '1.2',
                  ...
                  section.getIn(['cta', 'text']) && h('button', {
                    style: {
                ...
                h('div', {
                  ...
                  cards && cards.map(function(card, cardIndex) {
                    return h('div', {
                      ...
                      h('div', { style: { padding: '1.5rem', flex: '1', display: 'flex', flexDirection: 'column' } },
            ...
            case 'cta':
              return h('div', {
                ...
                style: {
                  ...
                  margin: '2rem 0',
                  display: 'grid',
                  gridTemplateColumns: section.get('image') ? '1fr 1fr' : '1fr',
                  gap: '2rem',
                  alignItems: 'center'
                }
              },
            ...
            case 'team_members':
              ...
              return h('div', { key: index, className: 'team-preview' },
                section.get('title') && h('h3', {
                  style: {
                    fontSize: '2rem',
                    fontWeight: '700',
                ...
                h('div', {
                  ...
                  members && members.map(function(member, memberIndex) {
                    return h('div', {
                      key: memberIndex,
                      style: {
                        flex: '1 1 210px',
                      ...
                      section.get('show_images') !== false && member.get('image') &&
                        h('div', {
                          style: {
                            width: '7rem',
                            height: '7rem',
            ...
            case 'contact_form':
              return h('div', { key: index, className: 'contact-form-preview' },
                section.get('title') && h('h3', {}, section.get('title')),
                section.get('description') && h('p', {}, section.get('description')),
                h('div', {
                  style: {
                  ...
                  h('div', { style: { marginBottom: '15px' } },
                    h('label', { style: { display: 'block', marginBottom: '5px' } }, 'Name'),
                    h('input', {
                      type: 'text',
                      style: {
                        width: '100%',
                  ...
                  h('div', { style: { marginBottom: '15px' } },
                    h('label', { style: { display: 'block', marginBottom: '5px' } }, 'Email'),
                    h('input', {
                      type: 'email',
                      style: {
                        width: '100%',
                  ...
                  h('div', { style: { marginBottom: '15px' } },
                    h('label', { style: { display: 'block', marginBottom: '5px' } }, 'Message'),
                    h('textarea', {
                      rows: 4,
                      style: {
                        width: '100%',
            ...
            case 'contact_form_socials':
              return h('div', { key: index, className: 'contact-form-socials-preview' },
                section.get('title') && h('h3', {}, section.get('title')),
                section.get('description') && h('p', {}, section.get('description')),
                h('div', {
                  style: {
